...
namespace Ecommerce.DAL.Data.Migrations
{
    ...
    [Migration("20260417153725_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.DAL.Data.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Ecommerce.DAL.Cart", b =>
                {
                    b.HasOne("Ecommerce.DAL.Data.Models.AppUser", "User")
                        .WithOne("Cart")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Ecommerce.DAL.Data.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
